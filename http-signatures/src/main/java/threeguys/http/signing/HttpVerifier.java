...
public class HttpVerifier {
    ...
    public HttpVerifier(RequestSigning signing, KeyProvider<PublicKey> keyProvider) {
        this(signing, keyProvider, Long.MAX_VALUE);
    }

    public HttpVerifier(RequestSigning signing, KeyProvider<PublicKey> keyProvider, long maxCreateAgeSec) {
